...
public class ManagedBuilderUIImages {
    ...
    static {
        iconBaseURL = Platform.getBundle("io.sloeber.autoBuild.ui").getEntry("icons/"); //$NON-NLS-1$ //$NON-NLS-2$
    }

    private static final String NAME_PREFIX = "io.sloeber.autoBuild.ui."; //$NON-NLS-1$
