...
<body role="document" ng-app='arduinoEclipse'>
	...
	<div class="container" role="main">
        ...
        <?php readfile ('http://eclipse.baeyens.it/fragments/file-list.php?arch=linux32.');?>
      

      <h3>Eclipse Update Site</h3>
		<p>Alternatively you can get the latest nightly build by setting the
			following update site within an existing Eclipse CDT installation</p>
		<div class="row">
