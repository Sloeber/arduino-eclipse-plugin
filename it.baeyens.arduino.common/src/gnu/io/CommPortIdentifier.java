...
public class CommPortIdentifier extends Object /* extends Vector? */
{
    ...
    /*------------------------------------------------------------------------------
     ...
     comments:
     ------------------------------------------------------------------------------*/
    public synchronized static CommPort open(@SuppressWarnings("unused") FileDescriptor f) throws UnsupportedCommOperationException {
	if (debug)
	    System.out.println("CommPortIdentifier:open(FileDescriptor)");
	throw new UnsupportedCommOperationException();
    }

    private native String native_psmisc_report_owner(@SuppressWarnings("hiding") String PortName);
