...
public class CommPortIdentifier extends Object /* extends Vector? */
{
	...
	static public CommPortIdentifier getPortIdentifier(String s) throws NoSuchPortException {
		...
		synchronized (Sync) {
			/*
			 * This may slow things down but if you pass the string for the port
			 * after a device is plugged in, you can find it now.
			 * 
	...
	/*------------------------------------------------------------------------------
	 ...
	 comments:
	 ------------------------------------------------------------------------------*/
	public synchronized static CommPort open(FileDescriptor f) throws UnsupportedCommOperationException {
		if (debug)
