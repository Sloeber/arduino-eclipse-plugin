...
final public class RXTXPort extends SerialPort {
	...
	*/
	...
	/**
	 * FIX ME I think this refers to FOPEN(3)/SETBUF(3)/FREAD(3)/FCLOSE(3)
	...
	*/
		...
		public void flush() throws IOException {
			...
			waitForTheNativeCodeSilly();
			/*
			 * this is probably good on all OS's but for now just sendEvent from
			 * java on Sol
			 */
			try {
	...
	*/
	 ...
	 * using.
	 * 
	 * @param int BaudBase The clock frequency divided by 16. Default BaudBase
	 *        is 115200.
	 * @return boolean true on success
	 * @throws UnsupportedCommOperationException
	 *             , IOException
