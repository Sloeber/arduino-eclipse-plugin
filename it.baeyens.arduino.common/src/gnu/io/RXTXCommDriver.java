...
public class RXTXCommDriver implements CommDriver {
	...
	private void registerValidPorts(String CandidateDeviceNames[], String ValidPortPrefixes[], int PortType) {
		...
		int p = 0;
		/*
		 * FIX ME quick fix to get COM1-8 on windows working. The Read test is
	...
	private void registerScannedPorts(int PortType) {
		...
		case CommPortIdentifier.PORT_PARALLEL:
			...
			if (osName.equals("Linux")
			/*
			 * || osName.equals("NetBSD") FIX ME || osName.equals("HP-UX") FIX
			 * ME || osName.equals("Irix") FIX ME || osName.equals("BeOS") FIX
			 * ME || osName.equals("Compaq's Digital UNIX") FIX ME
			 */
			) {
