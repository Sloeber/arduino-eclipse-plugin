...
public class Messages extends NLS {
    ...
    public static String launch_config_mainTab_browse;
    public static String launch_config_mainTab_main;
    public static String launch_config_mainTab_project;
    public static String launch_config_mainTab_project_selection;
    public static String launch_config_mainTab_project_wrong_type;
    public static String launch_config_mainTab_specify_project;
    public static String library_preference_page_add_remove;
    public static String never;
    public static String no;
    public static String no_project_found;
    ...
    public static String ui_append_link;
