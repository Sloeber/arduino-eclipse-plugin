 ...
 * //* {@link #getOptions()}.
 * //*
 * //* NOTE: The keys in the returned map are only used to efficiently override
 * the
 * //* values as this method
 * //* is invoked recursively. Once the recursion unwinds, the keys in the
 * resulting
 * //* map are a mixture of
 * //* actual option IDs and option superClass IDs. So the keys of the resulting
 * map
...
//
//  for (Option ourOpt : myOptionMap.values()) {
//      if (ourOpt.isValid()) {
