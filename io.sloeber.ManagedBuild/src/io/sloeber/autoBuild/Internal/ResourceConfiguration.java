...
public class ResourceConfiguration extends ResourceInfo implements IFileInfo {
     ...
     *
     * @param parent
     *            The <code>IConfiguration</code> the resource configuration will be
     *            added to.
     * @param element
     *            The XML element that contains the resource configuration settings.
     */
     ...
     *            added to.
     * @param cloneConfig
     *            The <code>ResourceConfiguration</code> to copy the settings from.
     * @param id
