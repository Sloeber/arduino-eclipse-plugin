...
public interface IManagedOptionValueHandler {
     ...
     */
    boolean handleValue(ISchemaObject configuration, IOptions holder, IOption option, String extraArgument, int event);
     ...
     */
    boolean isEnumValueAppropriate(ISchemaObject configuration, IOptions holder, IOption option, String extraArgument,
            String enumValue);
}
